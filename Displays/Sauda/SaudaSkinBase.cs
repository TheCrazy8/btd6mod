...
namespace BTD6Mod.Displays.Sauda;
...
public abstract class SaudaSkinBase : ModCustomDisplay
{
    ...
    public override void ModifyDisplayNode(UnityDisplayNode node)
    {
        ...
        BTD6Mod.ConfigureAnimationBaker(animationController.animationStates, 1, 1, 1, attackLeftClip);
        
        // Attack right animation
        BTD6Mod.ConfigureAnimationBaker(animationController.animationStates, 2, 2, 3, attackRightClip);
        
        // Attack middle animation
        BTD6Mod.ConfigureAnimationBaker(animationController.animationStates, 3, 3, 2, attackMiddleClip);
        
        // Attack stab animation
        BTD6Mod.ConfigureAnimationBaker(animationController.animationStates, 4, 4, 2, attackStabClip);

        // Upgrade animation
        BTD6Mod.ConfigureAnimationBaker(animationController.animationStates, 5, 5, 2, upgradeClip);
