...
public class BTD6Mod : BloonsTD6Mod
{
    ...
    {
        ModHelper.Msg<BTD6Mod>("BTD6 Chinese Skins loaded!");
    }
    ...
    public override void OnGameModelLoaded(GameModel model)
    {
        ...
        quincyPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "1",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl3]" }
            }
        );
        quincyPortraitsContainer.items.Add(new StorePortraits
            {
        ...
        quincyPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "7",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl7]" }
            }
        );
        quincyPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "10",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl10]" }
            }
        );
        quincyPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "20",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl20]" }
            }
        );
        ...
        quincySwapPrefabContainer.items.Add(new SwapPrefab
            {
                ...
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearQuincyLevel1"}
            }
        );
        quincySwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "f428ba21a9db9c441bf4b090c154edeb" },
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearQuincyLevel3"}
            }
        );
        quincySwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "9703101b845bf6e42a7e22e769cb0c40" },
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearQuincyLevel7"}
            }
        );
        quincySwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "f08231d7f2ac6f1438f76a6120910ccb" },
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearQuincyLevel10"}
            }
        );
        quincySwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "3db6fc68b301c6d48aac832f6894c384" },
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearQuincyLevel20"}
            }
        );
        ...
        quincySwapSpriteContainer.items.Add(new SwapSprite
            {
                ...
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl3]" }
            }
        );
        quincySwapSpriteContainer.items.Add(new SwapSprite
            {
        ...
        quincySwapSpriteContainer.items.Add(new SwapSprite
            {
                ...
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl7]" }
            }
        );
        quincySwapSpriteContainer.items.Add(new SwapSprite
            {
                assetToReplace = new SpriteReference { guidRef = "9f09f9e47a9e71a4fa8e607df6077456" },
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl10]" }
            }
        );
        quincySwapSpriteContainer.items.Add(new SwapSprite
            {
                assetToReplace = new SpriteReference { guidRef = "ec7590b408bb7014d93b3481c1873f93" },
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-QuincyNewYearPortraitLvl20]" }
            }
        );
        quincySwapSpriteContainer.items.Add(new SwapSprite
            {
        ...
        psiPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "1",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl1]" }
            }
        );
        psiPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "3",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl3]" }
            }
        );
        psiPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "10",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl8]" }
            }
        );
        psiPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "20",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl20]" }
            }
        );
        ...
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
                ...
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearPsiLevel1"}
            }
        );
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "d986bbeb30f071248914d0d89a532def" }, // lvl 3
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearPsiLevel3"}
            }
        );
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
        ...
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
                ...
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearPsiLevel10"}
            }
        );
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
        ...
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
                ...
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearPsiLevel20"}
            }
        );
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "e5daf50bbf24cde4aab87561b268251c" }, // addon lvl 1
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-PsiAddonLevel1"}
            }
        );
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "73415b8f4dc2df945a127504dde9bcde" }, // addon lvl 10
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-PsiAddonLevel10"}
            }
        );
        psiSwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "7576b2ab9c9246c42bb06d69d0de818a" }, // addon lvl 20
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-PsiAddonLevel20"}
            }
        );
        ...
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
                ...
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl1]" }
            }
        );
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
                assetToReplace = new SpriteReference { guidRef = "53eba3020aa5239499a5fc0ba04b561e" }, // lvl 3
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl3]" }
            }
        );
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
        ...
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
                ...
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl8]" }
            }
        );
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
        ...
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
                ...
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-PsiNewYearPortraitLvl20]" }
            }
        );
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
        ...
        psiSwapSpriteContainer.items.Add(new SwapSprite
            {
                ...
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-MandalaLV20]" }
            }
        );
        ...
        saudaPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "1",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl1]" }
            }
        );
        saudaPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "3",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl3]" }
            }
        );
        saudaPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "10",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl10]" }
            }
        );
        saudaPortraitsContainer.items.Add(new StorePortraits
            {
                levelTxt = "20",
                asset = new SpriteReference {guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl20]" }
            }
        );
        ...
        saudaSwapPrefabContainer.items.Add(new SwapPrefab
            {
                ...
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearSaudaLevel1"}
            }
        );
        saudaSwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "009016d8031477048bf86c9371fdf077" }, // lvl 3
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearSaudaLevel3"}
            }
        );
        saudaSwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "615d7f6284729bb47b88ca5e6f7fe700" }, // lvl 10
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearSaudaLevel10"}
            }
        );
        saudaSwapPrefabContainer.items.Add(new SwapPrefab
            {
                assetToReplace = new PrefabReference { guidRef = "ab00cf62f7e084648814fc8a9c1a4052" }, // lvl 20
                assetReplacement = new PrefabReference {guidRef = "BTD6Mod-NewYearSaudaLevel20"}
            }
        );
        ...
        saudaSwapSpriteContainer.items.Add(new SwapSprite
            {
                ...
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl1]" }
            }
        );
        saudaSwapSpriteContainer.items.Add(new SwapSprite
            {
                assetToReplace = new SpriteReference { guidRef = "b02425d2dfb113244bf770acf6e7b65e" }, // lvl 3
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl3]" }
            }
        );
        saudaSwapSpriteContainer.items.Add(new SwapSprite
            {
                assetToReplace = new SpriteReference { guidRef = "fefa503a6f02ffd4daf096b761c80274" }, // lvl 10
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl10]" }
            }
        );
        saudaSwapSpriteContainer.items.Add(new SwapSprite
            {
                assetToReplace = new SpriteReference { guidRef = "437e2270d2e17054b84d6cb471f78202" }, // lvl 20
                assetReplacement = new SpriteReference { guidRef = "Ui[BTD6Mod-SaudaNewYearPortraitLvl20]" }
            }
        );
        saudaSwapSpriteContainer.items.Add(new SwapSprite
            {
        ...
        var skinDataArray = new Il2CppReferenceArray<SkinData>(3)
        {
            ...
            [0] =
            {
                ...
                icon = new SpriteReference {guidRef = "Ui[BTD6Mod-HeroIconQuincyNewYear]"},
                iconSquare = new SpriteReference {guidRef = "Ui[BTD6Mod-HeroIconSquareQuincyNewYear]"},
            ...
            [1] =
            {
                ...
                textMaterialId = "Psi",
                icon = new SpriteReference {guidRef = "Ui[BTD6Mod-HeroIconPsiNewYear]"},
                iconSquare = new SpriteReference {guidRef = "Ui[BTD6Mod-HeroIconSquarePsiNewYear]"},
            ...
            [2] =
            {
                ...
                icon = new SpriteReference {guidRef = "Ui[BTD6Mod-HeroIconSaudaNewYear]"},
                iconSquare = new SpriteReference {guidRef = "Ui[BTD6Mod-HeroIconSquareSaudaNewYear]"},
    ...
    {
        var bundle = ModContent.GetBundle(ModHelper.GetMod("BTD6Mod"), "chineseport");
